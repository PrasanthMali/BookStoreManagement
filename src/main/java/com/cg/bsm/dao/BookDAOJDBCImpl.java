...
public class BookDAOJDBCImpl implements IBookDAO {
	...
	public String add(Book book) throws BookStoreException {
		String bcode = null;
		if (book != null) {
			try (Connection con = conProvider.getConnection();PreparedStatement pInsert = con.prepareStatement(IQueryMapper.ADD_BOOK_QRY)) {
	...
	public boolean delete(String bcode) throws BookStoreException {
		...
		try (Connection con = conProvider.getConnection();PreparedStatement pDelete = con.prepareStatement(IQueryMapper.DEL_BOOK_QRY)) {
	...
	public Book get(String bcode) throws BookStoreException {
		Book book=null;
		try (Connection con = conProvider.getConnection();PreparedStatement pSelect = con.prepareStatement(IQueryMapper.GET_BOOK_QRY)) {
